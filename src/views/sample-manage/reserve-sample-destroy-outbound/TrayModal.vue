...
<script lang="ts" setup>
  ...
  import { trayColumns } from '@/views/sample-manage/reserve-sample-destroy-outbound/reserve.data';
  import { keepPackOutBandTrayList } from '@/api/sample-manage/reserve-sample-destory';
  import {
  ...
  async function initTableData() {
    try {
      ...
      tableData.value = (await keepPackOutBandTrayList({
        dlvNo: dlvNo.value,
        ...values,
      } as GetApiCoreBankDeliverSampleTrayRequest)) as unknown as any;
    } finally {
