 ...
 * @更新时间 `2024-02-27 19:30:22`
 */
export interface PostApiCoreLabBagCheckResponse {
  currPage: number;
  pageSize: number;
  totalCount: number;
  result?: {
 ...
 * @更新时间 `2024-02-27 19:46:37`
 */
export interface PostApiCoreLabBagTiterResponse {
  currPage: number;
  pageSize: number;
  totalCount: number;
  result?: {
